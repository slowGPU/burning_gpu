...
class LogisticProcessor(nn.Module):
    def __init__(self, hidden_size: int = 32):
        ...
        self.fc_background_ratio = nn.Linear(hidden_size, 2)
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        background_ratio = background_ratio.view(b, 1, 1, 2).expand(b, h, w, 2)
...
class VarNetLogisticSens(LitBaseE2E):
    ...
    def __init__(
        ...
        def make_sme_image_processor():
            return LogisticProcessor(sens_hidden_size)
